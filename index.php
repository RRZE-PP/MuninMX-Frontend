        ...
        <div id="main" role="main">
            ...
            <div id="ribbon">
               <!-- breadcrumb -->
                <ol class="breadcrumb">
                    <li>Home</li><li>
                    <?php
                    if(!isset($_GET['action'])) { echo 'Your Nodes'; }
                    elseif (isset($_GET['action']) && $_GET['action'] == "groups") { 
                        echo 'Groups'; 
                        if (isset($_GET['selection'])) { echo '</li><li>'.$_GET['selection']; }
                    }
                    else { echo 'Add Nodes'; }
                    ?>
                    </li>
            ...
            <div id="content">
                ...
                <div class="row">
                    ...
                    elseif (isset($_GET['action']) && $_GET['action'] == "groups") { 
                        echo 'Groups'; 
                        if (isset($_GET['selection'])) { echo '</span><span>&nbsp;&nbsp;> '.$_GET['selection']; }
                    }
                    else { echo 'Add Nodes'; }
                    ?>
                            </span>
                            ...
                            <div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-x" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false" data-widget-sortable="false">
                                <header>
                                    ...
                                    <h2><?php  
                                        ...
                                        elseif (isset($_GET['action']) && $_GET['action'] == "groups") { 
                                            echo 'Groups';
                                             if (isset($_GET['selection'])) { echo ':  '.$_GET['selection']; }
                                        } 
